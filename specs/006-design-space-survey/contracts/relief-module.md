...
- It must not letter a figure. Lettering belongs to the plan, to the readout under it
  and to the schedule, which read spot heights; the relief carries the shape and the
  posts.
